...
✅ **Core Modules** (`src/immunos_mcp/core/`):
...
✅ **B Cell Agent** (`src/immunos_mcp/agents/bcell_agent.py`):
...
✅ **NK Cell Agent** (`src/immunos_mcp/agents/nk_cell_agent.py`):
...
│       │   ├── dendritic_agent.py  → Feature extraction (done)
│       │   └── memory_agent.py   → Knowledge cache (done)
│       │
│       ├── orchestrator/          ✅ Core orchestrator
│       │   └── orchestrator.py
│       │
│       └── servers/               🔜 MCP wrapper (optional)
